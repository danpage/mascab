...
\defbibfilter{f}{keyword={class=crossbut/ids}}
...
\printbibliography[ heading={subbibnumbered},    filter={f}, keyword={topic=attack/rowhammer},  title={Attacks: rowhammer-style techniques                                                    } ]
